...
**我们在其基础上新增加了跨语种拆音功能。[详情见此。](https://slidingwall.github.io/vocaloid-dictionaries/manual)**  
...
**Due to the update of new features, the traditional plugins have now been moved to the `archived` folder.**  
**由于新功能的更新，传统插件现已移至`archived`文件夹中。**  
...
|ENG VB|CLG UDC|N/A|FBO|CLG|CLG|
